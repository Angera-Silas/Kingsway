...
<title><?= htmlspecialchars($schoolName ?? 'KINGSWAY PREPARATORY SCHOOL') ?> — Boarder Fee Structure</title>
...
<div class="fs-document">
    ...
    ?>
        <div class="fs-student-section">
            <div class="fs-student-section-header">
                ...
                BOARDER — <?= htmlspecialchars($sectionName) ?> • <?= htmlspecialchars($yearLbl) ?>
            </div>
    ...
    <?php if (empty($sectionGroups)): ?>
        <div class="text-center text-muted py-4">No Boarder fee data available</div>
    <?php endif; ?>
