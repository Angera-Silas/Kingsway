...
$dashboardConfig = [
    ...
    'cards' => [
        ['id' => 'drvVehicle', 'label' => 'My Vehicle', 'icon' => 'bi-bus-front', 'colour' => 'dsc-blue', 'subtitle_id' => 'drvVehicleSub'],
        ['id' => 'drvRoute', 'label' => 'Active Route', 'icon' => 'bi-signpost-split', 'colour' => 'dsc-cyan', 'subtitle_id' => 'drvRouteSub'],
        ['id' => 'drvPassengers', 'label' => 'Passengers Today', 'icon' => 'bi-people', 'colour' => 'dsc-green', 'subtitle_id' => 'drvPassengersSub'],
        ['id' => 'drvIncidents', 'label' => 'Incidents', 'icon' => 'bi-exclamation-triangle', 'colour' => 'dsc-orange', 'subtitle_id' => 'drvIncidentsSub']
    ],
    'charts' => [
    ...
    'tables' => [
        ['body_id' => 'drvScheduleBody', 'title' => 'Upcoming Trips', 'columns' => ['Date', 'Time', 'Route', 'Status'], 'route' => 'my_routes', 'column' => 'col-xl-6'],
        ['body_id' => 'drvManifestBody', 'title' => 'Current Manifest', 'columns' => ['Student', 'Pickup', 'Drop-off', 'Status'], 'route' => 'transport_passengers', 'column' => 'col-xl-6']
    ],
    'quick_actions' => [
