# student_subject_performance.php

- **File**: `pages/student_subject_performance.php`
- **Controller**: `student_subject_performance.js`
- **Roles**: —
- **Sidebar item(s)**: —
...
| `GET academic/performance-overview` | `year_id`, `term_id`, `subject_id` | — |
