# observation_feedback.php

- **File**: `pages/observation_feedback.php`
- **Controller**: `observation_feedback.js`
- **Roles**: —
- **Sidebar item(s)**: —
...
|---|---|---|
| `GET /staff/observation-feedback` | — | — |
...
- `innerHTML`/`insertAdjacentHTML` assignments: `3` (with interpolation: `1`)
