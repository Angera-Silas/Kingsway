...
- **File**: `pages/manage_sms.php`
- **Controller**: `manage_sms.js`
- **Roles**: —
- **Sidebar item(s)**: —
...
| `communications.index` | — | — | GET /communications/index | Communications::index | ok |
...
- `communications.index -> sms_balance`
