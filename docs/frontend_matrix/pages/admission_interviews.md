# admission_interviews.php

- **File**: `pages/admission_interviews.php`
- **Controller**: `admission_interviews.js`
- **Roles**: —
- **Sidebar item(s)**: —
...
- `innerHTML`/`insertAdjacentHTML` assignments: `12` (with interpolation: `3`)
- `escapeHtml()` calls: `29` — XSS check: `PASS`
