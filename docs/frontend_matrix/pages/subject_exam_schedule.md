# subject_exam_schedule.php

- **File**: `pages/subject_exam_schedule.php`
- **Controller**: `subject_exam_schedule.js`
- **Roles**: —
- **Sidebar item(s)**: —
...
| `GET academic/exam-schedule` | `year_id`, `term_id`, `subject_id`, `subject_teacher_only` | — |
