# manage_students_admissions.php

- **File**: `pages/manage_students_admissions.php`
- **Controller**: `admissions_workspace.js`
- **Roles**: —
- **Sidebar item(s)**: —
...
- `innerHTML`/`insertAdjacentHTML` assignments: `21` (with interpolation: `0`)
- `escapeHtml()` calls: `60` — XSS check: `PASS`
