# reset_default_password.php

- **File**: `pages/reset_default_password.php`
- **Controller**: `reset_default_password.js`
- **Roles**: —
- **Sidebar item(s)**: —
...
|---|---|---|
| `POST /auth/reset-default-password` | `token` | — |

## Backend params (expected)

| Handler | Input keys ($data/$_POST/$_GET) | Path id | Data sources (views/procs/tables) |
|---|---|---|---|
| Auth::postResetDefaultPassword | `token`, `new_password`, `password` | — | user_invitations, users |
