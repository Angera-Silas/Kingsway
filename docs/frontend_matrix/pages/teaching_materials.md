# teaching_materials.php

- **File**: `pages/teaching_materials.php`
- **Controller**: `teaching_materials.js`
- **Roles**: —
- **Sidebar item(s)**: —
...
| `GET /academic/resources?type=material` | — | — |
...
| Academic::getResources | `type`, `class_id`, `subject_id`, `term_id`, `q` | — | academic_year_class_streams, academic_year_classes, classes, learning_areas, past_papers, persons, staff, teaching_materials |
...
- `innerHTML`/`insertAdjacentHTML` assignments: `4` (with interpolation: `2`)
