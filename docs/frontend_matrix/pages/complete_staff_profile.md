# complete_staff_profile.php

- **File**: `pages/complete_staff_profile.php`
- **Controller**: `complete_staff_profile.js`
- **Roles**: —
- **Sidebar item(s)**: —
...
|---|---|---|---|---|---|
| `staffMigration.onboarding` | — | — | GET /staff-migration/onboarding | StaffMigration::onboarding | ok |
| `staffMigration.completeProfile` | — | — | PUT /staff-migration/profile | StaffMigration::completeProfile | ok |
