# performance_trends.php

- **File**: `pages/performance_trends.php`
- **Controller**: `performance_trends.js`
- **Roles**: —
- **Sidebar item(s)**: —
...
| `academic.analyzeResults` | — | — | POST /academic/assessments-analyze-results | Academic::analyzeResults | ok |
| `academic.compileData` | — | — | POST /academic/reports-compile-data | Academic::compileData | ok |
