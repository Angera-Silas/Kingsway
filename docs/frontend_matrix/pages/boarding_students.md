# boarding_students.php

- **File**: `pages/boarding_students.php`
- **Controller**: `boarding_students.js`
- **Roles**: —
- **Sidebar item(s)**: —
...
- `innerHTML`/`insertAdjacentHTML` assignments: `9` (with interpolation: `2`)
- `escapeHtml()` calls: `37` — XSS check: `PASS`
