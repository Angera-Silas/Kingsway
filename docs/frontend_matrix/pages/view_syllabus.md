...
- **File**: `pages/view_syllabus.php`
- **Controller**: `view_syllabus.js`
- **Roles**: —
- **Sidebar item(s)**: —
...
|---|---|---|---|---|---|
| `academic.getSyllabus` | — | — | GET /academic/syllabus | Academic::getSyllabus | ok |

## Backend params (expected)

| Handler | Input keys ($data/$_POST/$_GET) | Path id | Data sources (views/procs/tables) |
|---|---|---|---|
| Academic::getSyllabus | — | — | learning_areas, learning_outcomes, strands, sub_strands |
