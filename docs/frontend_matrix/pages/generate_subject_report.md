# generate_subject_report.php

- **File**: `pages/generate_subject_report.php`
- **Controller**: `generate_subject_report.js`
- **Roles**: —
- **Sidebar item(s)**: —
...
| `GET academic/reports` | `report_type`, `year_id`, `term_id`, `subject_id`, `subject_teacher_only` | — |
...
| Academic::getReports | `report_type`, `class_id`, `subject_id` | — | — |
