...
- **File**: `pages/depreciation.php`
- **Controller**: `depreciation.js`
- **Roles**: —
- **Sidebar item(s)**: —
...
| Inventory::getDepreciation | `year`, `category_id` | — | asset_categories, fixed_assets |
