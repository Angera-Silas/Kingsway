# admissions_class_placement.php

- **File**: `pages/admissions_class_placement.php`
- **Controller**: `admissions_class_placement.js`
- **Roles**: —
- **Sidebar item(s)**: —
...
- `innerHTML`/`insertAdjacentHTML` assignments: `19` (with interpolation: `1`)
