# assign_subjects_to_teachers.php

- **File**: `pages/assign_subjects_to_teachers.php`
- **Controller**: `staff_access.js`
- **Roles**: —
- **Sidebar item(s)**: —
...
|---|---|---|---|---|---|
| `staff.getAccessContext` | — | — | GET /staff/access-context | Staff::getAccessContext | ok |

## Backend params (expected)

| Handler | Input keys ($data/$_POST/$_GET) | Path id | Data sources (views/procs/tables) |
|---|---|---|---|
| Staff::getAccessContext | — | — | staff, users |
