...
- **File**: `pages/staff_schedule.php`
- **Controller**: `staff_schedule.js`
- **Roles**: `System Administrator`
- **Sidebar item(s)**: `100120`
...
| `GET /schedules/timetable-time-slots` | — | — |
| `GET /schedules/timetable-get?` | — | — |
| `GET /schedules/staff-duty-schedule?` | — | — |
...
| Schedules::getTimetableTimeSlots | — | — | time_slots |
| Schedules::getTimetableGet | — | — | vw_timetable_entries, vw_timetable_entries |
| Schedules::getStaffDutySchedule | `staff_id`, `term_id` | `id` | — |
