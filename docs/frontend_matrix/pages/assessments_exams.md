# assessments_exams.php

- **File**: `pages/assessments_exams.php`
- **Controller**: `assessments_exams.js`
- **Roles**: —
- **Sidebar item(s)**: —
...
- `innerHTML`/`insertAdjacentHTML` assignments: `31` (with interpolation: `6`)
- `escapeHtml()` calls: `35` — XSS check: `PASS`
