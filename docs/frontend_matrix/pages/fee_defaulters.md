...
- **File**: `pages/fee_defaulters.php`
- **Controller**: `fee_defaulters.js`
- **Roles**: —
- **Sidebar item(s)**: —
...
| `communications.sendBulkFeeReminders` | `student_ids` | — | POST /communications/fee-reminder-bulk | Communications::sendBulkFeeReminders | ok |
| `communications.sendFeeReminder` | `student_id` | — | POST /communications/fee-reminder | Communications::sendFeeReminder | ok |
