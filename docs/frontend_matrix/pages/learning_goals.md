...
- **File**: `pages/learning_goals.php`
- **Controller**: `learning_goals.js`
- **Roles**: —
- **Sidebar item(s)**: —
...
|---|---|---|
| `GET /staff/learning-goals` | — | — |
| `PUT /staff/learning-goals/${id}` | — | — |
| `POST /staff/learning-goals` | — | — |
| `DELETE /staff/learning-goals/${id}` | — | — |
