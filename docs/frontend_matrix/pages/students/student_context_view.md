# students/student_context_view.php

- **File**: `pages/students/student_context_view.php`
- **Controller**: `student_context.js`
- **Roles**: —
- **Sidebar item(s)**: —
...
- `students.contextList -> fields`
- `students.contextList -> actions`
- `students.contextList -> pagination`
