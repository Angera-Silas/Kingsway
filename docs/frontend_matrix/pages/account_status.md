...
- **File**: `pages/account_status.php`
- **Controller**: `account_status.js`
- **Roles**: `System Administrator`
- **Sidebar item(s)**: `1012`, `100080`
...
|---|---|---|---|---|---|
| `system.getAccountStatuses` | — | — | GET /system/account-status | System::getAccountStatuses | ok |
| `system.updateAccountStatus` | — | — | PUT /system/account-status | System::updateAccountStatus | ok |
