# subject_schemes_of_work.php

- **File**: `pages/subject_schemes_of_work.php`
- **Controller**: `subject_schemes_of_work.js`
- **Roles**: —
- **Sidebar item(s)**: —
...
| `academic.getSubjectSchemes` | — | — | GET /academic/subject-schemes | Academic::getSubjectSchemes | ok |

## Backend params (expected)

| Handler | Input keys ($data/$_POST/$_GET) | Path id | Data sources (views/procs/tables) |
|---|---|---|---|
| Academic::getSubjectSchemes | — | — | — |
