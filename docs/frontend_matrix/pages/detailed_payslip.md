# detailed_payslip.php

- **File**: `pages/detailed_payslip.php`
- **Controller**: `detailed_payslip.js`
- **Roles**: —
- **Sidebar item(s)**: —
...
| `staff.downloadDetailedPayslip` | — | — | GET /staff/payroll-download-detailed-payslip?staff_id=&month=&year= | Staff::downloadDetailedPayslip | ok |
