# transaction_approvals.php

- **File**: `pages/transaction_approvals.php`
- **Controller**: `transaction_approvals.js`
- **Roles**: —
- **Sidebar item(s)**: —
...
|---|---|---|
| `GET /finance/expenses?status=pending_approval` | — | — |
| `GET /finance/expenses?status=approved` | — | — |
| `GET /finance/expenses?status=rejected` | — | — |
| `GET /finance/expenses/` | `status`, `notes` | — |
