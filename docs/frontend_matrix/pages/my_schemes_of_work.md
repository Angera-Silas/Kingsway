# my_schemes_of_work.php

- **File**: `pages/my_schemes_of_work.php`
- **Controller**: `my_schemes_of_work.js`
- **Roles**: —
- **Sidebar item(s)**: —
...
| `academic.getMySchemes` | — | — | GET /academic/my-schemes | Academic::getMySchemes | ok |

## Backend params (expected)

| Handler | Input keys ($data/$_POST/$_GET) | Path id | Data sources (views/procs/tables) |
|---|---|---|---|
| Academic::getMySchemes | — | — | — |
