...
- **File**: `pages/student_fees.php`
- **Controller**: `student_fees.js`
- **Roles**: —
- **Sidebar item(s)**: —
...
| `finance.getStudentFeeStatement` | `academic_year` | — | GET /finance/students/fee-statement/ | Finance::getStudentFeeStatement | ok |
...
- `innerHTML`/`insertAdjacentHTML` assignments: `13` (with interpolation: `0`)
