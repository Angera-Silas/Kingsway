# subject_class_comparison.php

- **File**: `pages/subject_class_comparison.php`
- **Controller**: `subject_class_comparison.js`
- **Roles**: —
- **Sidebar item(s)**: —
...
| `GET academic/results-analysis` | `year_id`, `term_id`, `subject_id` | — |
...
| Academic::getResultsAnalysis | — | — | academic_year_class_streams, academic_year_classes, academic_year_terms, assessment_results, assessments, classes, learning_areas, school_levels, student_academic_enrollments, students, term_subject_scores |

## Response shape (data keys consumed)

- `direct.callAPI -> subject_metrics`
- `direct.callAPI -> class_metrics`
