# generate_class_report.php

- **File**: `pages/generate_class_report.php`
- **Controller**: `generate_class_report.js`
- **Roles**: —
- **Sidebar item(s)**: —
...
| `GET academic/reports` | `report_type`, `year_id`, `term_id`, `class_id`, `class_teacher_only` | — |
