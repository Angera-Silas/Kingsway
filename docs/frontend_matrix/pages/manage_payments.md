...
- **File**: `pages/manage_payments.php`
- **Controller**: `manage_payments.js`
- **Roles**: —
- **Sidebar item(s)**: —
...
|---|---|---|---|---|---|
| `students.list` | `limit`, `status` | — | GET /students/student | Students::list | ok |
| `finance.getStudentPaymentStatusList` | `page`, `limit` | — | GET /finance/students/payment-status | Finance::getStudentPaymentStatusList | ok |
