...
- **File**: `pages/year_history.php`
- **Controller**: `year_history.js`
- **Roles**: —
- **Sidebar item(s)**: —
...
|---|---|---|---|---|---|
| `academic.getYearHistory` | — | — | GET /academic/year-history | Academic::getYearHistory | ok |

## Backend params (expected)

| Handler | Input keys ($data/$_POST/$_GET) | Path id | Data sources (views/procs/tables) |
|---|---|---|---|
| Academic::getYearHistory | — | — | academic_year_terms, academic_years, student_academic_enrollments |
