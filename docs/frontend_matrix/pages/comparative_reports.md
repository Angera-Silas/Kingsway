# comparative_reports.php

- **File**: `pages/comparative_reports.php`
- **Controller**: `comparative_reports.js`
- **Roles**: —
- **Sidebar item(s)**: —
...
| `reports.getAcademicYearReports` | — | — | GET /reports/academic-year-reports | Reports::getAcademicYearReports | ok |

## Backend params (expected)

| Handler | Input keys ($data/$_POST/$_GET) | Path id | Data sources (views/procs/tables) |
|---|---|---|---|
| Reports::getAcademicYearReports | — | — | — |
