...
- **File**: `pages/manage_whatsapp.php`
- **Controller**: `manage_whatsapp.js`
- **Roles**: `System Administrator`
- **Sidebar item(s)**: `100117`
...
| `communications.sendWhatsapp` | `recipients`, `message`, `type`, `variables`, `category` | — | POST /communications/send-whatsapp | Communications::sendWhatsapp | ok |
