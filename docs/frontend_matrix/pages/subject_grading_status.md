# subject_grading_status.php

- **File**: `pages/subject_grading_status.php`
- **Controller**: `subject_grading_status.js`
- **Roles**: —
- **Sidebar item(s)**: —
...
| `GET academic/assessments-list` | `year_id`, `term_id`, `subject_id` | — |
