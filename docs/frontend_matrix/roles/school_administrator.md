# School Administrator — Role Matrix
...
| users | 1 |
| sidebar items | 9 |
| route-level auth (role_routes) | 208 |
| dashboards | 1 |
| distinct endpoints | 49 |
...
|---|---|---|---|---|
| school_administrative_officer_dashboard | School Administrator Dashboard | components/dashboards/school_administrative_officer_dashboard.php | 12 | 0 |
...
|---|---|---|---|---|---|
| `GET /dashboard/school-admin/full` | dashboard | getSchoolAdminFull | `Dashboard::getSchoolAdminFull` | OK | dashboard:school_administrative_officer_dashboard |
| `GET /dashboard/school-admin/students` | dashboard | getSchoolAdminStudents | `Dashboard::getSchoolAdminStudents` | OK | dashboard:school_administrative_officer_dashboard |
| `GET /dashboard/school-admin/staff` | dashboard | getSchoolAdminStaff | `Dashboard::getSchoolAdminStaff` | OK | dashboard:school_administrative_officer_dashboard |
| `GET /dashboard/school-admin/attendance` | dashboard | getSchoolAdminAttendance | `Dashboard::getSchoolAdminAttendance` | OK | dashboard:school_administrative_officer_dashboard |
| `GET /dashboard/school-admin/admissions` | dashboard | getSchoolAdminAdmissions | `Dashboard::getSchoolAdminAdmissions` | OK | dashboard:school_administrative_officer_dashboard |
| `GET /dashboard/school-admin/timetables` | dashboard | getSchoolAdminTimetables | `Dashboard::getSchoolAdminTimetables` | OK | dashboard:school_administrative_officer_dashboard |
| `GET /dashboard/school-admin/announcements` | dashboard | getSchoolAdminAnnouncements | `Dashboard::getSchoolAdminAnnouncements` | OK | dashboard:school_administrative_officer_dashboard |
| `GET /dashboard/school-admin/system-status` | dashboard | getSchoolAdminSystemStatus | `Dashboard::getSchoolAdminSystemStatus` | OK | dashboard:school_administrative_officer_dashboard |
| `GET /dashboard/school-admin/pending-items` | dashboard | getSchoolAdminPendingItems | `Dashboard::getSchoolAdminPendingItems` | OK | dashboard:school_administrative_officer_dashboard |
| `GET /dashboard/school-admin/class-distribution?filter=` | dashboard | getSchoolAdminClassDistribution | `Dashboard::getSchoolAdminClassDistribution` | OK | dashboard:school_administrative_officer_dashboard |
| `GET /dashboard/school-admin/attendance-trend?weeks=` | dashboard | getSchoolAdminAttendanceTrend | `Dashboard::getSchoolAdminAttendanceTrend` | OK | dashboard:school_administrative_officer_dashboard |
| `GET /dashboard/school-admin/staff-directory` | dashboard | getSchoolAdminStaffDirectory | `Dashboard::getSchoolAdminStaffDirectory` | OK | dashboard:school_administrative_officer_dashboard |
...
| 41 | import_existing_students | home.php?route=import_existing_students |  |  |
...
| 215 | class_capacity | home.php?route=class_capacity |  |  |
...
| 100038 | website_content | api/website/content | WebsiteController | content |
| 100034 | website_events | api/website/events | WebsiteController | events |
| 100035 | website_gallery | api/website/gallery | WebsiteController | gallery |
| 100036 | website_jobs | api/website/jobs | WebsiteController | jobs |
| 100033 | website_news | api/website/news | WebsiteController | news |
| 100037 | website_settings | api/website/settings | WebsiteController | settings |
