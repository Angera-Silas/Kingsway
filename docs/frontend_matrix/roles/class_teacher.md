...
| users | 13 |
| sidebar items | 0 |
| route-level auth (role_routes) | 189 |
| dashboards | 1 |
...
|---|---|---|---|---|
| class_teacher_dashboard | Class Teacher Dashboard | components/dashboards/class_teacher_dashboard.php | 1 | 0 |
...
|---|---|---|---|---|---|
| `GET /dashboard/class-teacher/full` | dashboard | getClassTeacherFull | `Dashboard::getClassTeacherFull` | OK | dashboard:class_teacher_dashboard |

## Authorized routes (role_routes)

| route_id | Name | URL | Controller | Action |
|---|---|---|---|---|
| 26 | class_teacher_dashboard | home.php?route=class_teacher_dashboard |  |  |
| 86 | home | home.php |  |  |
