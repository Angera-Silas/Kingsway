# Deputy Head - Academic — Role Matrix
...
| users | 1 |
| sidebar items | 3 |
| route-level auth (role_routes) | 191 |
| dashboards | 1 |
...
|---|---|---|---|---|
| deputy_head_academic_dashboard | Deputy Head - Academic Dashboard | components/dashboards/deputy_head_academic_dashboard.php | 1 | 0 |

## Sidebar items

| id | Label | Type | Parent | URL | Route | Page | Controllers | Status |
|---|---|---|---|---|---|---|---|---|
| 100056 | Website | sidebar |  | manage_website | manage_website | manage_website.php | manage_website.js | ok (legacy callAPI) |
| 100057 | News & Blog | sidebar | Website | manage_website | manage_website | manage_website.php | manage_website.js | ok (legacy callAPI) |
| 100058 | School Events | sidebar | Website | manage_website | manage_website | manage_website.php | manage_website.js | ok (legacy callAPI) |

## Endpoint usage (dedup, all sources)

| Endpoint | Module | API method | Handler | Status | Source |
|---|---|---|---|---|---|
| `GET /dashboard/deputy-academic/full` | dashboard | getDeputyAcademicFull | `Dashboard::getDeputyAcademicFull` | OK | dashboard:deputy_head_academic_dashboard |
| `GET /website/stats` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `GET /website/categories` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `GET /website/news` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `GET /website/news/` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `PUT /website/news/` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `POST /website/news` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `DELETE /website/news/` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `GET /website/events` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `GET /website/events/` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `PUT /website/events/` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `POST /website/events` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `DELETE /website/events/` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `GET /website/gallery` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `POST /website/gallery` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `DELETE /website/gallery/` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `GET /website/downloads` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `PUT /website/downloads/` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `POST /website/downloads` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `DELETE /website/downloads/` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `GET /website/jobs` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `GET /website/jobs/` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `PUT /website/jobs/` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `POST /website/jobs` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `DELETE /website/jobs/` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `GET /website/applications` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `GET /website/job-applications` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `PUT /website/applications/` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `GET /website/inquiries` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `PUT /website/inquiries/` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `GET /website/content` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `PUT /website/content` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `POST /website/categories` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `DELETE /website/categories/` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `GET /website/settings` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `PUT /website/settings` | legacy | this.API | `Website::this.API` | OK | item:100056 |
| `GET /website/` | legacy | this.API | — | dynamic | item:100056 |
| `DELETE /website/` | legacy | this.API | — | dynamic | item:100056 |
...
| 216 | student_promotion | home.php?route=student_promotion |  |  |
...
| 214 | class_streams | home.php?route=class_streams |  |  |
