...
| users | 1 |
| sidebar items | 9 |
| route-level auth (role_routes) | 199 |
| dashboards | 1 |
| distinct endpoints | 45 |
...
|---|---|---|---|---|
| director_owner_dashboard | Director Dashboard | components/dashboards/director_owner_dashboard.php | 8 | 0 |
...
|---|---|---|---|---|---|
| `GET /dashboard/director/summary` | dashboard | getDirectorSummary | `Dashboard::getDirectorSummary` | OK | dashboard:director_owner_dashboard |
| `GET /payments/trends` | dashboard | getPaymentsTrends | `Payments::getPaymentsTrends` | OK | dashboard:director_owner_dashboard |
| `GET /payments/revenue-sources` | dashboard | getPaymentsRevenueSources | `Payments::getPaymentsRevenueSources` | OK | dashboard:director_owner_dashboard |
| `GET /academics/kpis` | dashboard | getAcademicsKpis | `Academic::getAcademicsKpis` | OK | dashboard:director_owner_dashboard |
| `GET /academics/performance-matrix` | dashboard | getAcademicsPerformanceMatrix | `Academic::getAcademicsPerformanceMatrix` | OK | dashboard:director_owner_dashboard |
| `GET /attendance/trends` | dashboard | getAttendanceTrends | `Attendance::getAttendanceTrends` | OK | dashboard:director_owner_dashboard |
| `GET /dashboard/director/risks` | dashboard | getDirectorRisks | `Dashboard::getDirectorRisks` | OK | dashboard:director_owner_dashboard |
| `GET /dashboard/director/announcements` | dashboard | getDirectorAnnouncements | `Dashboard::getDirectorAnnouncements` | OK | dashboard:director_owner_dashboard |
...
| 100027 | school_settings | home.php?route=school_settings |  |  |
