# Intern/Student Teacher — Role Matrix
...
| users | 1 |
| sidebar items | 0 |
| route-level auth (role_routes) | 184 |
| dashboards | 1 |
...
|---|---|---|---|---|
| intern_student_teacher_dashboard | Intern Teacher Dashboard | components/dashboards/intern_student_teacher_dashboard.php | 1 | 0 |
...
|---|---|---|---|---|---|
| `GET /dashboard/intern-teacher/full` | dashboard | getInternTeacherFull | `Dashboard::getInternTeacherFull` | OK | dashboard:intern_student_teacher_dashboard |
