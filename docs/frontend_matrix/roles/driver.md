...
|---|---|---|---|---|
| driver_dashboard | Driver Dashboard | components/dashboards/driver_dashboard.php | 3 | 0 |
...
|---|---|---|---|---|---|
| `GET /transport/my-route` | transport | getMyRoute | `Transport::getMyRoute` | OK | dashboard:driver_dashboard |
| `GET /transport/my-vehicle` | transport | getMyVehicle | `Transport::getMyVehicle` | OK | dashboard:driver_dashboard |
| `GET /transport/route-manifest?route_id=` | transport | getRouteManifest | `Transport::getRouteManifest` | OK | dashboard:driver_dashboard |
