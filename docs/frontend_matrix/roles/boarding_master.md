...
| users | 1 |
| sidebar items | 0 |
| route-level auth (role_routes) | 108 |
| dashboards | 1 |
| distinct endpoints | 4 |
...
|---|---|---|---|---|
| matron_housemother_dashboard | Boarding Master Dashboard | components/dashboards/matron_housemother_dashboard.php | 4 | 0 |
...
|---|---|---|---|---|---|
| `GET /boarding/stats` | boarding | getStats | `Boarding::getStats` | OK | dashboard:matron_housemother_dashboard |
| `GET /boarding/occupancy` | boarding | getOccupancy | `Boarding::getOccupancy` | OK | dashboard:matron_housemother_dashboard |
| `GET /boarding/roll-call` | boarding | getRollCalls | `Boarding::getRollCalls` | OK | dashboard:matron_housemother_dashboard |
| `GET /boarding/exeats` | boarding | getExeats | `Boarding::getExeats` | OK | dashboard:matron_housemother_dashboard |
