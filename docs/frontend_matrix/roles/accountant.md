...
| users | 1 |
| sidebar items | 0 |
| route-level auth (role_routes) | 188 |
| dashboards | 1 |
...
|---|---|---|---|---|
| school_accountant_dashboard | Accountant Dashboard | components/dashboards/school_accountant_dashboard.php | 2 | 0 |
...
|---|---|---|---|---|---|
| `GET /dashboard/accountant/financial` | dashboard | getAccountantFinancial | `Dashboard::getAccountantFinancial` | OK | dashboard:school_accountant_dashboard |
| `GET /dashboard/accountant/payments` | dashboard | getAccountantPayments | `Dashboard::getAccountantPayments` | OK | dashboard:school_accountant_dashboard |
...
| 59 | manage_expenses | home.php?route=manage_expenses |  |  |
