...
| users | 1 |
| sidebar items | 0 |
| route-level auth (role_routes) | 104 |
| dashboards | 1 |
| distinct endpoints | 3 |
...
|---|---|---|---|---|
| catering_manager_cook_lead_dashboard | Cateress Dashboard | components/dashboards/catering_manager_cook_lead_dashboard.php | 3 | 0 |
...
|---|---|---|---|---|---|
| `GET /catering/stats` | catering | getStats | `Catering::getStats` | OK | dashboard:catering_manager_cook_lead_dashboard |
| `GET /catering/menu` | catering | getMenu | `Catering::getMenu` | OK | dashboard:catering_manager_cook_lead_dashboard |
| `GET /catering/food-stock` | catering | getFoodStock | `Catering::getFoodStock` | OK | dashboard:catering_manager_cook_lead_dashboard |
