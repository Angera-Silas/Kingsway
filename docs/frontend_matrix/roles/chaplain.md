...
|---|---|---|---|---|
| school_counselor_chaplain_dashboard | Chaplain Dashboard | components/dashboards/school_counselor_chaplain_dashboard.php | 1 | 0 |
...
|---|---|---|---|---|---|
| `GET /counseling/summary` | counseling | getSummary | `Counseling::getSummary` | OK | dashboard:school_counselor_chaplain_dashboard |
