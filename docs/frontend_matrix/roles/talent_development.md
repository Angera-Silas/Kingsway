# Talent Development — Role Matrix
...
| users | 1 |
| sidebar items | 4 |
| route-level auth (role_routes) | 101 |
| dashboards | 1 |
...
|---|---|---|---|---|
| hod_talent_development_dashboard | Talent Development Dashboard | components/dashboards/hod_talent_development_dashboard.php | 3 | 0 |

## Sidebar items

| id | Label | Type | Parent | URL | Route | Page | Controllers | Status |
|---|---|---|---|---|---|---|---|---|
| 100062 | Website | sidebar |  | manage_website | manage_website | manage_website.php | manage_website.js | ok (legacy callAPI) |
| 100063 | Post News | sidebar | Website | manage_website | manage_website | manage_website.php | manage_website.js | ok (legacy callAPI) |
| 100064 | School Events | sidebar | Website | manage_website | manage_website | manage_website.php | manage_website.js | ok (legacy callAPI) |
| 100065 | Gallery | sidebar | Website | manage_website | manage_website | manage_website.php | manage_website.js | ok (legacy callAPI) |

## Endpoint usage (dedup, all sources)

| Endpoint | Module | API method | Handler | Status | Source |
|---|---|---|---|---|---|
| `GET /activities/statistics/get` | activities | getSummary | `Activities::getSummary` | OK | dashboard:hod_talent_development_dashboard |
| `GET /activities` | activities | list | `Activities::list` | OK | dashboard:hod_talent_development_dashboard |
| `GET /activities/schedules/list` | activities | listSchedules | `Activities::listSchedules` | OK | dashboard:hod_talent_development_dashboard |
| `GET /website/stats` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `GET /website/categories` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `GET /website/news` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `GET /website/news/` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `PUT /website/news/` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `POST /website/news` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `DELETE /website/news/` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `GET /website/events` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `GET /website/events/` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `PUT /website/events/` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `POST /website/events` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `DELETE /website/events/` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `GET /website/gallery` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `POST /website/gallery` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `DELETE /website/gallery/` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `GET /website/downloads` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `PUT /website/downloads/` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `POST /website/downloads` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `DELETE /website/downloads/` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `GET /website/jobs` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `GET /website/jobs/` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `PUT /website/jobs/` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `POST /website/jobs` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `DELETE /website/jobs/` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `GET /website/applications` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `GET /website/job-applications` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `PUT /website/applications/` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `GET /website/inquiries` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `PUT /website/inquiries/` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `GET /website/content` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `PUT /website/content` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `POST /website/categories` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `DELETE /website/categories/` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `GET /website/settings` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `PUT /website/settings` | legacy | this.API | `Website::this.API` | OK | item:100062 |
| `GET /website/` | legacy | this.API | — | dynamic | item:100062 |
| `DELETE /website/` | legacy | this.API | — | dynamic | item:100062 |
