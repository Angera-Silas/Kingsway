<?php
/** Kingsway System Administrator: Webhook Registry. */
?>
<div class="container-fluid py-4"
     data-system-admin-page
     data-resource="webhooks"
     data-mode="crud"
     data-title="Webhook Registry">
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4">
        <div>
            <h2 class="h3 mb-1">Webhook Registry</h2>
            <p class="text-muted mb-0">Maintain outbound webhook subscriptions.</p>
        </div>
        ...
        <div class="modal-content">
            <form data-system-form>
                <div class="modal-header">
                    <h5 class="modal-title" data-system-modal-title>Webhook Registry</h5>
