<?php
/** Kingsway System Administrator: Rate Limiting. */
?>
<div class="container-fluid py-4"
     data-system-admin-page
     data-resource="rate-limits"
     data-mode="readonly"
     data-title="Rate Limiting">
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4">
        <div>
            <h2 class="h3 mb-1">Rate Limiting</h2>
            <p class="text-muted mb-0">Inspect and configure API rate-limit policies.</p>
        </div>
        ...
        <div class="modal-content">
            <form data-system-form>
                <div class="modal-header">
                    <h5 class="modal-title" data-system-modal-title>Rate Limiting</h5>
