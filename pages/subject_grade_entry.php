<?php
/**
 * Subject Grade Entry - Subject Teacher Grade Entry
 * Role: Subject Teacher (8)
 * Purpose: Enter marks for assessments for their assigned subjects
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">
                        <i class="bi bi-pencil-square me-2"></i>Enter Subject Grades
                    </h5>
                    <small class="text-muted">Enter marks for your subject assessments</small>
                </div>
                <div class="card-body">
                    ...
                    <div id="marksContent" style="display: none;">
                        ...
                        <div id="assessmentInfo" class="alert alert-info mb-3" style="display: none;">
                            ...
                            <strong>Subject:</strong> <span id="assessmentSubject"></span><br>
...
<script src="js/pages/subject_grade_entry.js?v=<?= filemtime(APP_BASE_PATH . "/js/pages/subject_grade_entry.js") ?>"></script>
