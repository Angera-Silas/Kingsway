<?php
/** Kingsway System Administrator: Time-Bound Access. */
?>
<div class="container-fluid py-4"
     data-system-admin-page
     data-resource="time-bound-access"
     data-mode="crud"
     data-title="Time-Bound Access">
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4">
        <div>
            <h2 class="h3 mb-1">Time-Bound Access</h2>
            <p class="text-muted mb-0">Manage temporary role and permission grants.</p>
        </div>
        ...
        <div class="modal-content">
            <form data-system-form>
                <div class="modal-header">
                    <h5 class="modal-title" data-system-modal-title>Time-Bound Access</h5>
