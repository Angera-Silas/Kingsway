<?php
/** Kingsway System Administrator: Dashboard Registry. */
?>
<div class="container-fluid py-4"
     data-system-admin-page
     data-resource="dashboards"
     data-mode="crud"
     data-title="Dashboard Registry">
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4">
        <div>
            <h2 class="h3 mb-1">Dashboard Registry</h2>
        ...
        <div class="modal-content">
            <form data-system-form>
                <div class="modal-header">
                    <h5 class="modal-title" data-system-modal-title>Dashboard Registry</h5>
