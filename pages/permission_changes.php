<?php
/** Kingsway System Administrator: Permission Changes. */
?>
<div class="container-fluid py-4"
     data-system-admin-page
     data-resource="permission-changes"
     data-mode="readonly"
     data-title="Permission Changes">
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4">
        <div>
            <h2 class="h3 mb-1">Permission Changes</h2>
            <p class="text-muted mb-0">Review role and permission assignment changes.</p>
        </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white d-flex flex-wrap gap-2 justify-content-between align-items-center">
            <strong>Permission Changes</strong>
        ...
        <div class="modal-content">
            <form data-system-form>
                <div class="modal-header">
                    <h5 class="modal-title" data-system-modal-title>Permission Changes</h5>
