<?php
/** Kingsway System Administrator: Widget Registry. */
?>
<div class="container-fluid py-4"
     data-system-admin-page
     data-resource="widgets"
     data-mode="crud"
     data-title="Widget Registry">
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4">
        <div>
            <h2 class="h3 mb-1">Widget Registry</h2>
            <p class="text-muted mb-0">Register dashboard widgets and their permission requirements.</p>
        </div>
        ...
        <div class="modal-content">
            <form data-system-form>
                <div class="modal-header">
                    <h5 class="modal-title" data-system-modal-title>Widget Registry</h5>
