<?php
/**
 * Subject Exam Schedule - Subject Teacher Exam Schedule Viewing
 * Role: Subject Teacher (8)
 * Purpose: View exam schedules for their assigned subjects
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">
                        <i class="bi bi-calendar-event me-2"></i>Subject Exam Schedule
                    </h5>
                    <small class="text-muted">Exam schedules for your assigned subjects</small>
                </div>
                <div class="card-body">
                    ...
                    <div id="scheduleContent" style="display: none;">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <div id="statsContainer" class="d-flex gap-3">
                                <span class="badge bg-primary">Total Exams: <span id="totalExams">0</span></span>
                                <span class="badge bg-success">Upcoming: <span id="upcomingExams">0</span></span>
                                <span class="badge bg-warning">Completed: <span id="completedExams">0</span></span>
                            </div>
                        </div>
