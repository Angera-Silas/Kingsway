<?php
/**
 * Enter Exam Results - School Admin Exam Results Entry
 * Role: School Administrator (4)
 * Purpose: Enter exam results for all students
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">
                        <i class="bi bi-pencil-square me-2"></i>Enter Exam Results
                    </h5>
                    <small class="text-muted">Enter exam results for all students</small>
                </div>
                <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div class="d-flex gap-2">
                                <button id="saveAllBtn" class="btn btn-primary" data-permission="assessments_edit">
                                    <i class="bi bi-save me-1"></i>Save All Results
                                </button>
                            ...
                            <div id="statsContainer" class="d-flex gap-3">
                                ...
                                <span class="badge bg-success">Results Entered: <span id="enteredStudents">0</span></span>
...
<script src="js/pages/enter_exam_results.js?v=<?= filemtime(APP_BASE_PATH . "/js/pages/enter_exam_results.js") ?>"></script>
