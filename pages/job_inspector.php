<?php
/** Kingsway System Administrator: Job Inspector. */
?>
<div class="container-fluid py-4"
     data-system-admin-page
     data-resource="job-inspector"
     data-mode="jobs"
     data-title="Job Inspector">
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4">
        <div>
            <h2 class="h3 mb-1">Job Inspector</h2>
            <p class="text-muted mb-0">Inspect job payloads, attempts and failures.</p>
        </div>
        ...
        <div class="modal-content">
            <form data-system-form>
                <div class="modal-header">
                    <h5 class="modal-title" data-system-modal-title>Job Inspector</h5>
