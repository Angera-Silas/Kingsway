<?php
/** Kingsway System Administrator: Permission Policies. */
?>
<div class="container-fluid py-4"
     data-system-admin-page
     data-resource="policies"
     data-mode="crud"
     data-title="Permission Policies">
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4">
        <div>
            <h2 class="h3 mb-1">Permission Policies</h2>
            <p class="text-muted mb-0">Maintain policy rules and effects.</p>
        </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white d-flex flex-wrap gap-2 justify-content-between align-items-center">
            <strong>Permission Policies</strong>
        ...
        <div class="modal-content">
            <form data-system-form>
                <div class="modal-header">
                    <h5 class="modal-title" data-system-modal-title>Permission Policies</h5>
