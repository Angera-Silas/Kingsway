<?php
/** Kingsway System Administrator: Sidebar Menus. */
?>
<div class="container-fluid py-4"
     data-system-admin-page
     data-resource="sidebar-menus"
     data-mode="crud"
     data-title="Sidebar Menus">
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4">
        <div>
            <h2 class="h3 mb-1">Sidebar Menus</h2>
            <p class="text-muted mb-0">Maintain sidebar groups and menu entries.</p>
        </div>
        ...
        <div class="modal-content">
            <form data-system-form>
                <div class="modal-header">
                    <h5 class="modal-title" data-system-modal-title>Sidebar Menus</h5>
