<?php
/** Kingsway System Administrator: Maintenance Mode. */
?>
<div class="container-fluid py-4"
     data-system-admin-page
     data-resource="maintenance"
     data-mode="crud"
     data-title="Maintenance Mode">
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4">
        <div>
            <h2 class="h3 mb-1">Maintenance Mode</h2>
        ...
        <div class="modal-content">
            <form data-system-form>
                <div class="modal-header">
                    <h5 class="modal-title" data-system-modal-title>Maintenance Mode</h5>
