<?php
/** Kingsway System Administrator: Domain Isolation. */
?>
<div class="container-fluid py-4"
     data-system-admin-page
     data-resource="domain-isolation"
     data-mode="crud"
     data-title="Domain Isolation">
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4">
        <div>
            <h2 class="h3 mb-1">Domain Isolation</h2>
            <p class="text-muted mb-0">Maintain domain and tenant isolation rules.</p>
        </div>
        ...
        <div class="modal-content">
            <form data-system-form>
                <div class="modal-header">
                    <h5 class="modal-title" data-system-modal-title>Domain Isolation</h5>
