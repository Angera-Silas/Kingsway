<?php
/** Kingsway System Administrator: Feature Flags. */
?>
<div class="container-fluid py-4"
     data-system-admin-page
     data-resource="feature-flags"
     data-mode="crud"
     data-title="Feature Flags">
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4">
        <div>
            <h2 class="h3 mb-1">Feature Flags</h2>
            <p class="text-muted mb-0">Enable, disable and roll out platform capabilities.</p>
        </div>
        ...
        <div class="modal-content">
            <form data-system-form>
                <div class="modal-header">
                    <h5 class="modal-title" data-system-modal-title>Feature Flags</h5>
