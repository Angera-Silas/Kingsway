<?php
/** Kingsway System Administrator: Route Access Rules. */
?>
<div class="container-fluid py-4"
     data-system-admin-page
     data-resource="route-rules"
     data-mode="crud"
     data-title="Route Access Rules">
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4">
        <div>
            <h2 class="h3 mb-1">Route Access Rules</h2>
            <p class="text-muted mb-0">Map routes and HTTP methods to required permissions.</p>
        </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white d-flex flex-wrap gap-2 justify-content-between align-items-center">
            <strong>Route Access Rules</strong>
        ...
        <div class="modal-content">
            <form data-system-form>
                <div class="modal-header">
                    <h5 class="modal-title" data-system-modal-title>Route Access Rules</h5>
