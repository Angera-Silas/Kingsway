...
<div>
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h4 class="mb-1"><i class="bi bi-subtract me-2"></i>Class Streams</h4>
                    <p class="text-muted mb-0">View and manage class streams</p>
                </div>
                <button class="btn btn-primary" onclick="ClassStreamsController.showAddModal()" data-permission="academic_create"><i class="bi bi-plus-lg me-1"></i> Add New</button>
            </div>
        </div>
    </div>
    ...
    <div class="row mb-4">
        <div class="col-md-3 mb-3">
            <div class="card shadow-sm border-0"><div class="card-body"><div class="d-flex align-items-center">
                <div class="rounded-circle bg-primary bg-opacity-10 p-3 me-3"><i class="bi bi-building text-primary fa-lg"></i></div>
                <div><h6 class="text-muted mb-1">Total Classes</h6><h4 class="mb-0" id="statClasses">0</h4></div>
            </div></div></div>
        </div>
        <div class="col-md-3 mb-3">
            <div class="card shadow-sm border-0"><div class="card-body"><div class="d-flex align-items-center">
                <div class="rounded-circle bg-success bg-opacity-10 p-3 me-3"><i class="bi bi-subtract text-success fa-lg"></i></div>
        ...
        <div class="col-md-3 mb-3">
            <div class="card shadow-sm border-0"><div class="card-body"><div class="d-flex align-items-center">
                <div class="rounded-circle bg-warning bg-opacity-10 p-3 me-3"><i class="bi bi-arrows-fullscreen-arrows-alt text-warning fa-lg"></i></div>
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-2"><button class="btn btn-outline-secondary w-100" onclick="ClassStreamsController.refresh()"><i class="bi bi-arrow-clockwise"></i></button></div>
            </div>
        </div>
    </div>
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-white d-flex justify-content-between align-items-center">
            <h6 class="mb-0"><i class="bi bi-table me-2"></i>Class Streams</h6>
            <button class="btn btn-sm btn-outline-success" onclick="ClassStreamsController.exportCSV()"><i class="bi bi-file-csv me-1"></i> Export</button>
        </div>
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover mb-0" id="dataTable">
                    <thead class="table-light"><tr><th scope="col">#</th><th scope="col">Class (Grade)</th><th scope="col">Stream Name</th><th scope="col">Class Teacher</th><th scope="col">Students</th><th scope="col">Capacity</th><th scope="col">Utilization %</th><th scope="col">Status</th><th scope="col">Actions</th></tr></thead>
...
<div class="modal fade" id="formModal" tabindex="-1"><div class="modal-dialog"><div class="modal-content">
    <div class="modal-header"><h5 class="modal-title" id="formModalTitle"><i class="bi bi-subtract me-2"></i>Add Record</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div>
