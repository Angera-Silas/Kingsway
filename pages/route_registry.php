<?php
/** Kingsway System Administrator: Route Registry. */
?>
<div class="container-fluid py-4"
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4">
        <div>
            <h2 class="h3 mb-1">Route Registry</h2>
            <p class="text-muted mb-0">Maintain the canonical application route registry.</p>
        </div>
        ...
        <div class="modal-content">
            <form data-system-form>
                <div class="modal-header">
                    <h5 class="modal-title" data-system-modal-title>Route Registry</h5>
