<?php
/** Kingsway System Administrator: System Settings. */
?>
<div class="container-fluid py-4"
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Maintain system-level key/value configuration.</p>
        </div>
        ...
        <div class="modal-content">
            <form data-system-form>
                <div class="modal-header">
                    <h5 class="modal-title" data-system-modal-title>System Settings</h5>
