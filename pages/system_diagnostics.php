<?php
/** Kingsway System Administrator: System Diagnostics. */
?>
<div class="container-fluid py-4"
     data-system-admin-page
     data-resource="diagnostics"
     data-mode="readonly"
     data-title="System Diagnostics">
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4">
        <div>
            <h2 class="h3 mb-1">System Diagnostics</h2>
            <p class="text-muted mb-0">Run platform diagnostics and inspect environment details.</p>
        </div>
        ...
        <div class="modal-content">
            <form data-system-form>
                <div class="modal-header">
                    <h5 class="modal-title" data-system-modal-title>System Diagnostics</h5>
