<?php
/** Kingsway System Administrator: API Metrics. */
?>
<div class="container-fluid py-4"
     data-system-admin-page
     data-resource="api-metrics"
     data-mode="readonly"
     data-title="API Metrics">
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4">
        <div>
            <h2 class="h3 mb-1">API Metrics</h2>
            <p class="text-muted mb-0">Inspect endpoint latency, status and throughput metrics.</p>
        </div>
        ...
        <div class="modal-content">
            <form data-system-form>
                <div class="modal-header">
                    <h5 class="modal-title" data-system-modal-title>API Metrics</h5>
