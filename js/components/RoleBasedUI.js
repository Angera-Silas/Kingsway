...
const RoleBasedUI = (() => {
  ...
  const ROLE_IDS = {
    ...
    security: 19,
    groundsman: 20,
    talent_development: 21,
    food_store_manager: 71,
    librarian: 72,
    lab_technician: 22,
    counselor: 23,
    chaplain: 24,
  ...
  const ROLE_TO_LAYOUT = {
    ...
    "Uniform Store Manager": "manager",
    "Food Store Manager": "manager",
  ...
  function renderSidebar(navItems, container) {
    ...
    let html = `
      <div class="logo-section">
        <img src="${(window.APP_BASE || '')}/uploads/school_assets/official_school_logo.png" alt="Kingsway Logo" onerror="this.onerror=null;this.src='${(window.APP_BASE || '')}/images/official_school_logo.png';">
